...
@section('page_title','Manage Offer Category')
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Mange Offer Category</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                    ...
                    <div class="col-6 offset-3">
                        ...
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title">Manage Offer Category Detail</h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form class="form-horizontal" method="post" action="{{route('offer.manage_offer_category_process')}}" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                ...
                                <div class="card-footer">
                                    ...
                                    <a href="{{url('admin/offer-categories')}}"class="btn btn-default float-right">Cancel</a>
                                </div>
                                <!-- /.card-footer -->
                            </form>
                        </div>
